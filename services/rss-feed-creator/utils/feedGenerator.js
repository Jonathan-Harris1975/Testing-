...
const FEED_RETENTION_DAYS = Number(ENV.FEED_RETENTION_DAYS) || 7; // default 7 days
...
export async function generateFeed(bucket, rewrittenItems) {
  try {
    ...
    const channelTitle =
      ENV.RSS_FEED_TITLE?.trim() || "Turing's Torch: AI Weekly";
    const channelLink = "https://jonathan-harris.online";
    const channelDesc =
      ENV.RSS_FEED_DESCRIPTION?.trim() ||
