...
export const ENV = {
  ...
  r2: {
    ...
    R2_BUCKET_PODCAST_OUTPUT: opt("R2_BUCKET_PODCAST_OUTPUT"),
    R2_BUCKET_RAW_TEXT_INPUT: opt("R2_BUCKET_RAW_TEXT_INPUT"),
    ...
    // Legacy/compat (read-only)
    R2_PUBLIC_BASE_URL_PODCAST_OUTPUT: opt("R2_PUBLIC_BASE_URL_PODCAST_OUTPUT"),
